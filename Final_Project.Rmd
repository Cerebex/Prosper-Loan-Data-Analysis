...
are the most likely to make an investor are large return? I also want to
understand how specific credit ratings and score relate to borrowers 
...
```{r, include = FALSE}
setwd(paste("/Users/samuelmiller/Documents/Udacity/Data\ Analyst\ ",
               "Nanodegree/Exploring\ and\ Summarizing\ Data/",
               "EDA_Course_Materials/Final\ Project", sep=""))
...
to see wierd areas around credit score 600-620 and 780-800 that do not 
...
While there are many defualted or chargedoff loans, most loans are current
or compeleted.
...
positively skewed with a media nof $6500 and a maximum of $35000. 
...
distribation is easier to see if it is placed on a a log scale.
...
Leading up to the 2008 financial crisis there seemed to be a large increas in
...
Most of the largely correlated items in the correlation matrix are interelated
and do not shead large insights into relationships in the data alone.
...
increases aswell. This can be seen with a F value of 13792 with an extremely 
...
on average actually comes from D CreditGrade grade loans with a mean value of 
$1293.00.
...
Seems that people who chargeoff or defualt on their loans
...
do to randomn variance based since these two varaibles have a F value of 55574
and extremely low p values for all pairs in a POST HOC test. Another important
oberservation is that even with 
a specific credit
...
ussually the highest estimated return.
...
Charged Off and Defualted loans tended to have a higher return estimate. Sadly, 
...
higher Credit Grades but still alot of high paying jobs still have bad 
credit ratings.
...
It would seem higher the borrower's credit grade, the larger thier loan amount 
...
this becuase it takes a large amount of capital to build a home before being
able to sell it?
...
Charge-offs happened from people with a small to large number deliquences 
...
have the potential to yeild significantly lower to negative returns.
...
It seems the number of recommendations a borrower recieved did not play a large
role in the Estimated Return from their loan on average. At the same time it 
seems HR loans were alot more likely to have negative returns.  
...
lower credit grades have the potential to give higher returns in normal 
prosperous economic times. On the other hand, in bad economic times they also 
have the potential to yeild significantly lower to negative returns. It is very 
important for investors to truly understand how difficult it is to get their 
money back at all if someones loan is chargedoff.
...
loans since I am guessing many investors who use the ebay for loans don't 
...
I wished I could have had been given more background on each of the dataset's 
variables. I truly tried to calculate how much money people overall made from
all the loans but this was very difficult. I wanted to understand in general 
the overall payout of all loans for investors on Prosper. Sadly this dataset 
made this extremely difficult since I could not completely figure out how 
the data was created. For example, listing number 150265 had a Net Principal 
Loss of $7603.16 on a $20,000 laon but had non-principal recovery payments 
amounting to $21,117.90. How is this possible? 

I would also love to have more data on the investors themselves. How much money 
do these investors make a year and what background do they have in investing? 
This could give me a better understanding on whether someone with no investing 
...
returns on average. Do banks refuse to lend out moeny to specific borrowers
